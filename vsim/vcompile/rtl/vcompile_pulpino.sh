...
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes +define+ASIC ${CORE_DEFINES} ${RTL_PATH}/sp_ram_wrap.sv        || goto error
...
vlog -quiet -sv -work ${LIB_PATH} +incdir+${RTL_PATH}/includes ${ASIC_DEFINES} ${CORE_DEFINES} ${RTL_PATH}/tsmc_wrap.sv          || goto error
